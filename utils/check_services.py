...
infinity_server = server_url + ':7997/health'
gemma_server = server_url + ':11434/v1/chat/completions'
paligemma_server = server_url + ':5443/generate'
gemma_test_payload = {
...
for _ in range(max_retry):
    try:
        ...
        print(f'Number of retries remaining: {_}')
